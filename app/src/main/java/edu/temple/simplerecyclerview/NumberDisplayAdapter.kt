...
class NumberDisplayAdapter (private val numbers: Array<Int>, private val onNumberClicked: (Int) -> Unit) : RecyclerView.Adapter<NumberDisplayAdapter.NumberViewHolder>() {
    ...
    inner class NumberViewHolder (layout: View) : RecyclerView.ViewHolder (layout) {
        ...
        val textView = layout.findViewById<TextView>(R.id.textView).apply{
            setOnClickListener{
                onNumberClicked(numbers[adapterPosition])
            }
        }
